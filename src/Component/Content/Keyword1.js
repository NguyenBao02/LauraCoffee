...
import kw_4 from "../../assets/image/kw_1-4.png"
import kw_5 from "../../assets/image/kw_1-5.png"

const Keyword1 = () => {
    return (
        <div className="keyword-container">
            <h2 className="mb-4">Tham Gia Cuộc Thi Sáng Tạo Cà Phê Cùng Các Fluencer Của Laura Coffee</h2>
            <p>Bạn có đam mê cà phê và yêu thích sáng tạo? Hãy cùng Laura Coffee khám phá hành trình pha chế đầy cảm hứng thông qua <b>cuộc thi sáng tạo cà phê</b> với sự góp mặt của các <b>tiktoker</b> hàng đầu! Đây là cơ hội tuyệt vời để bạn thể hiện tài năng pha chế và chia sẻ những công thức cà phê độc đáo, đậm chất cá nhân.</p>
            ...
            <h4>2. Đồng Hành Cùng Các Tiktoker Nổi Tiếng</h4>
            ...
            <p>TikToker Công Ken đã tham gia cuộc thi <b>Laura Coffee</b> bằng cách sáng kết hợp cà phê laura với long đỏ trứng gà để tạo thành ly cà phê trứng độc đáo mới lạ.</p>
            <div className="keyword-image">
                <a href="https://www.youtube.com/embed/1boWnLefy0g?feature=oembed">
                    <img src={kw_4} alt="anh" />
                </a>
                <span>Cà phê trứng</span>
            </div>
            <p>TikToker "Bon Đây Nè" đã tham gia sáng tạo cà phê Laura bằng cách kết hợp với những nguyên liệu khác lạ như rau câu và phê mai để làm viên cà phê nhân phô mai.</p>
            <div className="keyword-image">
                <a href="https://www.youtube.com/embed/e2U40PZnNlw?feature=oembed">
                    <img src={kw_5} alt="anh" />
                </a>
                <span>Viên cà phê phô mai</span>
            </div>
            ...
            <p>1 giải nhất: 1 combo 10 hộp Cafe Laura + 5.000.000 tiền mặt</p>
            <p>1 giải nhì:1 combo 10 hộp Cafe Laura + 3.000.000 tiền mặt</p>
            <p>2 giải ba: 1 combo 10 hộp Cafe Laura + 1.000.000 tiền mặt mặt</p>
            <p>10 giải khuyến khích: 1 combo 10 hộp cafe Laura</p>
            <div className="keyword-image">
                <a>
            ...
            <p>- Gửi Video:Người chơi đăng tải video lên nền tảng TikTokvà gắn thẻ trang của Laura Coffee, hoặc gửi video qua một nền tảng tải lên video mà bạn chỉ định.</p>
            <p>- Hashtag: Sử dụng hashtag chiến dịch #LauraCoffeeChallenge #CaféCreativity</p>
